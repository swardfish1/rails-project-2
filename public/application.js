...
var changeRecipe = function changeRecipe(data) {
  return $.ajax({
    method: 'PATCH',
...
var deleteRecipe = function deleteRecipe(data) {
  return $.ajax({
    method: 'DELETE',
    url: url.apiUrl + 'recipes/' + $(event.target).data('id'),
    headers: {
...
var recipeList = __webpack_require__(15);
...
var signedInState = function signedInState() {
...
var signedOutState = function signedOutState() {
...
var hideRecipes = function hideRecipes() {
  $('.showRecipes').html('');
};
...
var createRecipeSuccess = function createRecipeSuccess(signUpResponse) {
  $('#alert').html('\n    <div class= "alert fade alert-success alert-dismissable">\n      <button type="button" class="close" aria-hidden="true" data-dismiss="alert">&times;</button>\n      Recipe made.\n    </div>\n    ');
  $('.showRecipes').html('');
  $('#add-recipe').trigger('reset');
};

var createRecipeError = function createRecipeError(error) {
  $('#alert').html('\n    <div class= "alert alert-danger alert-dismissable fade in">\n      <button type="button" class="close" aria-hidden="true" data-dismiss="alert">&times;</button>\n      Could not make recipe.\n    </div>\n    ');
  $('#add-recipe').trigger('reset');
};

var getRecipeSuccess = function getRecipeSuccess(data) {
  var showRecipeHtml = recipeList({ recipes: data.recipes });
  $('.showRecipes').removeClass('collapsed').html(showRecipeHtml);
  $('#your-recipes-title').removeClass('hidden');
};

var getRecipeError = function getRecipeError(error) {
  $('#alert').html('\n    <div class= "alert fade alert-danger alert-dismissable fade in">\n      <button type="button" class="close" aria-hidden="true" data-dismiss="alert">&times;</button>\n      Could not make recipe.\n    </div>\n    ');
};

var editRecipeSuccess = function editRecipeSuccess(data) {
...
var editRecipeError = function editRecipeError(error) {
...
var deleteRecipeError = function deleteRecipeError() {
  $('#alert').html('\n    <div class= "alert alert-danger alert-dismissable fade in">\n      <button type="button" class="close" aria-hidden="true" data-dismiss="alert">&times;</button>\n      Could not make recipe.\n    </div>\n    ');
};
...
$(function () {
  ...
  $('#recipe-hide').on('click', ui.hideRecipes);
...
var onSignIn = function onSignIn(event) {
  event.preventDefault();
  var data = getFormFields(event.target);
  api.signIn(data).then(function (result) {
...
var onCreateRecipe = function onCreateRecipe(event) {
  event.preventDefault();
  var data = getFormFields(event.target);
  api.createRecipe(data).then(ui.createRecipeSuccess).catch(ui.createRecipeError).then(api.getRecipe).then(ui.getRecipeSuccess);
};

var onGetRecipe = function onGetRecipe(event) {
  event.preventDefault();
  api.getRecipe().then(ui.getRecipeSuccess).catch(ui.getRecipeError);
};

var onEditRecipe = function onEditRecipe(event) {
  event.preventDefault();
  var data = getFormFields(event.target);
  api.changeRecipe(data).then(ui.editRecipeSuccess).catch(ui.editRecipeError);
};

var onDeleteRecipe = function onDeleteRecipe(event) {
  event.preventDefault();
  var data = getFormFields(event.target);
  api.deleteRecipe(data).then(ui.deleteRecipeSuccess).catch(ui.deleteRecipeError);
};
...
var apiUrl = void 0;
var apiUrls = {
  production: 'https://glacial-reaches-36198.herokuapp.com/',
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return "  <div class=\"card\">\n    <div class=\"card-container\">\n      <div class=\"card-body\">\n        <h3>"
    ...
    + "</h3>\n        <h4>Instructions:</h4><h5>"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.instructions : stack1), depth0))
    + "</h5>\n        <button data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\" class=\"btn btn-primary btn-sm edit-button\">Edit Recipe</button>\n        <button type=\"button\" class=\"delete-button btn btn-danger btn-sm\" data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\">Delete Recipe</button>\n        <br><br>\n      </div>\n      <div data-id=\"edit"
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\" class=\"edit-section section collapsed\">\n        <hr>\n        <button data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\" type=button class=\"close no-edit\">&times;</button>\n        <form class=\"edit-recipe form-inline\" data-id=\""
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
    + "\">\n          <strong>Title</strong> <input type=\"text\" name=\"recipe[title]\" placeholder=\"recipe title\" class=\"form-control\">\n          <strong>Instructions</strong> <textarea name=\"recipe[instructions]\" form=\"edit-recipe\" class=\"form-control\" placeholder=\"Recipe Instructions\"></textarea>\n          <button type=\"submit\" class=\"btn btn-primary btn-sm card-button\">Save</button>\n        </form>\n      </div>\n    </div>\n  </div>\n";
...
// module
exports.push([module.i, "/* Formatting Misc */\n.mt-3 {\n  margin-top: 3em;\n}\n\n.hidden {\n  display: none;\n}\n\n.float-right {\n  float: right;\n}\n\n.float-left {\n  float: left;\n}\n\n.block {\n  display: inline-block;\n}\n\n.clearfix {\n  overflow: hidden;\n  display: inline-block;\n}\n", ""]);
